...
<head>
    ...
    <title>Add Project - EU Projects in MNE</title>
        ...
        <div class="main-content">
            ...
            <form method="POST" class="user-form">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="financial_framework" name="financial_framework">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="type_of_programme" name="type_of_programme">
                </div>
                
                <div class="form-group">
                    <label for="management_mode">Management Mode:</label>
                    <input type="text" id="management_mode" name="management_mode">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="sector_1" name="sector_1">
                </div>
                
                <div class="form-group">
                    <label for="sector_2">Sector 2:</label>
                    <input type="text" id="sector_2" name="sector_2">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="commitment_year" name="commitment_year">
                </div>
                
                <div class="form-group">
                    <label for="contract_year">Contract Year:</label>
                    <input type="text" id="contract_year" name="contract_year">
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="contracting_party" name="contracting_party" rows="2"></textarea>
                </div>
                
                <div class="form-group">
                    <label for="decision_number">Decision Number:</label>
                    <input type="text" id="decision_number" name="decision_number">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" step="0.01" id="contracted_eu_contribution" name="contracted_eu_contribution">
                </div>
                
                <div class="form-group">
                    <label for="eu_contribution_mne">EU Contribution for MNE (€):</label>
                    <input type="number" step="0.01" id="eu_contribution_mne" name="eu_contribution_mne">
                </div>
                
                <div class="form-group">
                    <label for="eu_contribution_overall">EU Contribution Overall (€):</label>
                    <input type="number" step="0.01" id="eu_contribution_overall" name="eu_contribution_overall">
                </div>
                
                <div class="form-group">
                    <label for="total_euro_value">Total EURO Value (€):</label>
                    <input type="number" step="0.01" id="total_euro_value" name="total_euro_value">
                </div>
